...
%edited
The combination of the two models requires some thought. The Gompertz-Chemo integrated model for tumor burden can be added in place of the logistic growth factor in the immune system model, but the effects of the chemotherapy on the immune cells cannot be ignored. Although sources were inconclusive on whether the chemotherapy directly killed the NK and CD8+ cells, it is known that all cells are negatively affected by the therapy. The number of NK and CD8+ cells affected by the chemotherapy is proportional to \eqref{eq: chemo} and the current number of cells of each type. This results in the following system of equations.
...
\begin{figure}[h!]
\begin{center} %Put your images in a figure like this
\includegraphics[scale=0.6]{./images/tumor_growth.pdf} % Better to make them pdfs than png or gif or jpeg
\end{center}
...
\begin{figure}[h!]
\begin{center} %Put your images in a figure like this
\includegraphics[scale=0.6]{./images/CD8_growth.pdf} % Better to make them pdfs than png or gif or jpeg
\end{center}
...
\label{fig:CD8growth} % for automatic cross referencing
\end{figure}


\begin{figure}[h!]
\begin{center} %Put your images in a figure like this
\includegraphics[scale=0.6]{./images/NK_growth.pdf} % Better to make them pdfs than png or gif or jpeg
\end{center}
...
\label{fig:NKgrowth} % for automatic cross referencing
\end{figure}
...
The overall model has some unique strengths and weaknesses as well. As shown above, it predicts that after a certain number of chemotherapy treatments the cancer will die out due to the immune response overwhelming the trace amounts of cells. It also accurately show that if not enough chemotherapy treatments are given, the tumor burden returns to high levels rather quickly. 

While it does not break down after 1 month like the immune model it does, however, show a concerning dependence on initial conditions. With a large initial tumor burden, the model shows that the burden will decrease under effects of the immune system alone, which runs counter to what is observed.

%end new

Weaknesses
Sensitivity to initial conditions
Some question of constants
